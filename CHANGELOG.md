...
- Pydantic models `Concept` and `KnowledgeGraph` (frozen/immutable) with
  `KnowledgeGraph.add_concept()` and `KnowledgeGraph.remove_concept()`
  (`190f43c`, `fe17398`, `ec03862`).
...
- `docs/decisions/0001-kmd-flat-format-superseded.md` and
  `docs/decisions/0002-okf-v0-1-bundle-format.md` (the latter supersedes the
